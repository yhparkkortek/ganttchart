        ...
        try {
            ...
            if (!modal) {
                ...
                modal.innerHTML =
                    ...
                    '<button id="issue-rpt-reload" onclick="window._issueRptReload()" onmouseover="this.style.background=\'#ffefc0\'; this.style.borderColor=\'#e0b64a\';" onmouseout="this.style.background=\'#fff8e6\'; this.style.borderColor=\'#ffe08a\';" style="font-size:11.5px; padding:4px 10px; border:1px solid #ffe08a; background:#fff8e6; color:#7a5210; border-radius:6px; cursor:pointer; transition:background .15s, border-color .15s;"></button>' +
                    '<button id="issue-rpt-export" onclick="window._issueExportDigest()" onmouseover="this.style.background=\'#ffefc0\'; this.style.borderColor=\'#e0b64a\';" onmouseout="this.style.background=\'#fff8e6\'; this.style.borderColor=\'#ffe08a\';" style="font-size:11.5px; padding:4px 10px; border:1px solid #ffe08a; background:#fff8e6; color:#7a5210; border-radius:6px; cursor:pointer; transition:background .15s, border-color .15s;"></button>' +
