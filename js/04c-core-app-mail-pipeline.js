...
// 섹션: project_index.json 메일 자동처리 파이프라인용 경량 프로젝트 인덱스
    ...
    window._saveToGoogleDriveRaw = async function(opts) {
        ...
        try {
            ...
            // 🐛 [2026-09-11 버그 수정] 바로 아래 필수 정보 검증은 opts.suppressAlert를 확인하는데, 이 체크는
            //    그걸 빼먹고 항상 alert()을 띄우고 있었다 — 3분 자동저장·메일 완전자동배치 등 백그라운드
            //    저장 경로가 suppressAlert:true를 넘겨도, 프로젝트가 아직 거의 비어있는 순간(예: Summary
